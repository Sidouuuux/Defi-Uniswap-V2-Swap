...
contract UniswapV2SwapTest is Test {
    ...
    function testSwapSingleHopExactAmountIn() public {
        console.log("DAI contract balance before swap", dai.balanceOf(address(this)));
        ...
        console.log("DAI contract balance after swap", dai.balanceOf(address(this)));
        assertGe(daiAmountOut, daiAmountMin, "amount out < min");
    }

    // Swap DAI -> WETH -> USDC
    function testSwapMultiHopExactAmountIn() public {
        console.log("USDC contract balance before swap", usdc.balanceOf(address(this)));
        ...
        console.log("USDC contract balance after swap", usdc.balanceOf(address(this)));
    ...
    function testSwapSingleHopExactAmountOut() public {
        console.log("USDC contract balance before swap", dai.balanceOf(address(this)));
        ...
        console.log("USDC contract balance after swap", dai.balanceOf(address(this)));
